...
namespace svglib {
  ...
  class SVGBuilder
  {
    ...
    private:
      ...
      double pen_width_;
      bool show_coords_;
      clipperlib::PathsI paths_;
      bool is_open_path;
    public:
      PathInfo(const clipperlib::PathsI &paths, bool is_open,
  ...
  public:
    ...
    void AddPath(const clipperlib::PathI &path, bool is_open, unsigned brush_color,
      unsigned pen_color, double pen_width, bool show_coords);
    void AddPaths(const clipperlib::PathsI &paths, bool is_open, unsigned brush_color,
      unsigned pen_color, double pen_width, bool show_coords);
    bool SaveToFile(const std::wstring &filename, int max_width, int max_height, int margin);
  }; //class
